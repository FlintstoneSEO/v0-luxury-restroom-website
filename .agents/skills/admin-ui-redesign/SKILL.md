...
description: Use when improving or redesigning the admin side of the luxury restroom trailer site, including admin dashboard, quote detail pages, pricing admin, media admin, settings, filters, status badges, forms, responsive admin UX, and accessibility. Do not use for public marketing page redesign unless explicitly requested.
---
...
The interface should feel premium, professional, fast, accessible, and operationally clear.

## Required admin design brief
...
## Pricing and settings redesign guidance
...
- Preview or calculation examples where helpful
