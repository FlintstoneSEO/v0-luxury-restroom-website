...
export default function QuoteApprovalView({ token, quote }: { token: string; quote: any }) {
  ...
  return (
    <div className="quote-typography min-h-screen bg-[#ded2c4]/20 py-10 px-4">
      <div className="mx-auto max-w-3xl rounded-xl border border-[#ded2c4] bg-white p-6 space-y-5">
        ...
        <div className="rounded-lg border border-[#ded2c4] p-4 space-y-2 text-base">
        ...
        <div>
          <label className="text-base font-medium text-[#2d3a47]">Comments (required for request changes or decline)</label>
        ...
        {message && <p className="text-base text-[#2d3a47]">{message}</p>}
      </div>
    </div>
  );
}
