export const homepageImages = {
  ...
  services: {
    ...
    constructionLongTerm: {
      ...
      alt: "Reliable long-term restroom trailer rental at an active construction site in Michigan",
    },
    disasterReliefGovernment: {
      src: "/images/Disaster Relief Trailer.png",
      alt: "Emergency restroom trailer support for disaster response and government operations in Michigan",
    },
  },
  cta: {
    msuTailgate: {
