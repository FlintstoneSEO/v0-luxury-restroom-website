...
const title = 'Emergency Restroom Trailer Rentals in Michigan | Signature Luxe Events'
const description = 'Arrange temporary emergency restroom trailer rentals in Michigan for outages, disaster response, and municipal support with rapid scheduling and reliable service.'
const canonical = 'https://www.signatureluxeevents.com/emergency-disaster-relief-restroom-trailers'
export const metadata: Metadata = { title, description, alternates: { canonical }, openGraph: { title, description, url: canonical } }

export default function Page() {
  return <ServicePageTemplate pageTitle='Emergency and Disaster Relief Restroom Trailers' serviceName='Emergency restroom trailer rental' urlPath='/emergency-disaster-relief-restroom-trailers' intro='When facilities are unavailable due to outages, weather events, or emergency response operations, dependable temporary restroom access is essential for public and team safety.' ctaTitle='Request a Quote for Emergency and Disaster Relief Restroom Trailers' sections={[
