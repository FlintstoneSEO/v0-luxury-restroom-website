...
const title = 'Wedding Restroom Trailer Rentals in Michigan | Signature Luxe Events'
const description = 'Plan wedding restroom trailer rentals in Lansing and Mid-Michigan with climate-controlled comfort, polished interiors, and logistics support for outdoor venues.'
const canonical = 'https://www.signatureluxeevents.com/wedding-restroom-trailer-rentals'
export const metadata: Metadata = { title, description, alternates: { canonical }, openGraph: { title, description, url: canonical } }

export default function Page() {
  return <ServicePageTemplate pageTitle='Wedding Restroom Trailer Rentals' serviceName='Wedding restroom trailer rental' urlPath='/wedding-restroom-trailer-rentals' intro='Outdoor weddings across Lansing and Mid-Michigan need restroom access that matches the look and feel of the celebration. Our wedding trailer rentals are designed for guest comfort, formal attire, and smooth venue flow.' ctaTitle='Request a Quote for Wedding Restroom Trailer Rentals' sections={[
