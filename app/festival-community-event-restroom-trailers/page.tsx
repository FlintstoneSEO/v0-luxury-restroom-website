...
const title = 'Festival & Community Event Restroom Trailer Rentals in Lansing, MI | Signature Luxe Events'
const description = 'Secure festival restroom trailer rentals in Lansing and Mid-Michigan with high-volume planning, sanitation scheduling, and multi-day event support.'
...
export default function Page() {
  return <ServicePageTemplate pageTitle='Festival and Community Event Restroom Trailers' serviceName='Festival restroom trailer rental' urlPath='/festival-community-event-restroom-trailers' intro='Public events require restroom planning that supports higher attendance and predictable usage waves. We help organizers coordinate trailer placement and service schedules for smoother operations.' ctaTitle='Request a Quote for Festival and Community Event Restroom Trailers' sections={[
