...
const title = 'Construction & Long-Term Restroom Trailer Rentals in Lansing, MI | Signature Luxe Events'
const description = 'Get long-term restroom trailer rentals for construction sites and temporary facilities in Lansing and Mid-Michigan with dependable service schedules and site planning.'
const canonical = 'https://www.signatureluxeevents.com/construction-long-term-restroom-trailer-rentals'
export const metadata: Metadata = { title, description, alternates: { canonical }, openGraph: { title, description, url: canonical } }

export default function Page() {
  return <ServicePageTemplate pageTitle='Construction and Long-Term Restroom Trailer Rentals' serviceName='Construction restroom trailer rental' urlPath='/construction-long-term-restroom-trailer-rentals' intro='Construction and long-term projects need clean facilities that hold up through daily use. We provide scheduled service and trailer planning for crews across Lansing and Mid-Michigan.' ctaTitle='Request a Quote for Construction and Long-Term Restroom Trailer Rentals' sections={[
